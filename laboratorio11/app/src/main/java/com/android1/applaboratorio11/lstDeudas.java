...
public class lstDeudas extends AppCompatActivity {
    private RecyclerView ress;
    private static String url = "http://192.168.1.41/minimarKet/deudas.php";
    List<Deudas> deudasList;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lst_deudas);

        ress = findViewById(R.id.reDeu);
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        deudasList.add(new Deudas(Compras.getString ("Codigo"),
                                Compras.getString("Cliente"),
                                Compras.getString("Deuda"),
                    ...
                    AdapterDeudas adapter = new AdapterDeudas(lstDeudas.this, deudasList);
